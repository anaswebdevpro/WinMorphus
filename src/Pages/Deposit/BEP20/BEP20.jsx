...
const BEP20 = () => {
  ...
  const walletAddress = "0x9ec6fDDFF04d2A57e793944f1B7421057c86b714";
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      <div className="max-w-7xl mx-auto p-6">
        ...
        {/* Header with Status */}
        <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-lg p-6 mb-8 flex items-start justify-between">
          <div className="flex items-center gap-4">
            <div className="bg-emerald-500 p-3 rounded-full">
              <span className="text-2xl text-white font-bold">₮</span>
            </div>
            <div>
              <h1 className="text-3xl font-bold text-white">USDT BEP20</h1>
              <p className="text-emerald-100 text-sm">BEP20 Network Payment</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-orange-100 rounded-lg p-6">
                ...
                <p className="text-slate-900 text-2xl font-bold">BEP20</p>
              </div>
            </div>
            ...
            <div className="bg-emerald-100 border-2 border-emerald-400 rounded-lg p-6">
            ...
            <div className="bg-blue-600/20 border border-blue-500/40 rounded-lg p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  Deposits will be confirmed within 10-30 minutes on the BEP20
                  network.
                </p>
              </div>
            </div>
