  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
      <div className="max-w-7xl mx-auto p-6">
        ...
        {/* Coming Soon Section */}
        <div className="bg-[var(--bg-card)] border border-[var(--border-primary)] rounded-lg p-12 text-center">
          <div className="max-w-2xl mx-auto">
            <div className="mb-6 flex justify-center">
              <div className="relative">
                ...
                <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-[var(--bg-tertiary)] rounded-full flex items-center justify-center border-2 border-[var(--bg-card)]">
            ...
            <p className="text-[var(--text-secondary)] text-lg mb-6">
              We're working on something special for our loyal members. Stay
              tuned for exclusive rewards and benefits!
            </p>
